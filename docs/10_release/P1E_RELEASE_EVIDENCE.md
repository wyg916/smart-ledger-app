...
- debug APK 为 191,000,972 bytes，SHA-256
  ...
  不是商店发布工件。
- 功能分支四组 CI `31005929979`、`31005930023`、`31005929996`、`31005930029` 全部成功；
  仅在确认 P1E 远端仍为 `0592012` 后执行 `--ff-only` 与普通推送。P1E 合入后四组 CI
  `31006458176`、`31006458194`、`31006458282`、`31006458180` 再次全部成功，main 未修改。
